...
/**
 * Converts a string date in the format "MM/DD/YYYY" to a Date object.
 * Adjusts month and day indexes to accommodate JavaScript's Date object indexing (0-based for months).
 *
